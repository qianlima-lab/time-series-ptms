...
if __name__ == '__main__':
    ...
    parser.add_argument('--train-file', type=str, default='KPI-anomaly-detection-datasets/phase2_train.csv')
    parser.add_argument('--test-file', type=str, default='KPI-anomaly-detection-datasets/phase2_ground_truth.hdf')
    ...
    for k in all_data:
        ...
        print(k)
        print("train set:")
        print("data-", np.shape(all_train_data[k])) #[train_length]
        print("labels-", np.shape(all_train_labels[k])) #[train_length]
        print("timestamps-", np.shape(all_train_timestamps[k])) #[train_length]
        print("test set:")
        print("data-", np.shape(all_test_data[k])) #[test_length]
        print("labels-", np.shape(all_test_labels[k])) #[test_length]
        print("timestamps-", np.shape(all_test_timestamps[k])) #[test_length]
